...
class RejectSwapAction extends RowAction
{
    public $name = 'Từ chối';
    ...
    public function handle(Model $model)
    {
        ...
        try {
            ...
            $response = $controller->reject(request(), $model->id);
    ...
    {
        $this->textarea('admin_notes', 'Lý do từ chối')->rows(3)->placeholder('Nhập lý do từ chối...')->required();
    }
