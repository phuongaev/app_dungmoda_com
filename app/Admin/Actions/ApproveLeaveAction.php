...
class ApproveLeaveAction extends RowAction
{
    public $name = 'Duyệt';
    ...
    {
        return '<a class="btn btn-xs btn-success grid-row-approve-leave" data-id="'.$this->getKey().'"><i class="fa fa-check"></i> Duyệt</a>';
    }
}