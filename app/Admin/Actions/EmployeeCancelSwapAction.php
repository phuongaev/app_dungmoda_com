...
class EmployeeCancelSwapAction extends RowAction
{
    public $name = 'Hủy đơn';
    ...
    {
        try {
            $controller = new \App\Admin\Controllers\EmployeeShiftSwapController();
    ...
    {
        $this->confirm('Bạn có chắc chắn muốn hủy đơn hoán đổi ca này?');
    }
